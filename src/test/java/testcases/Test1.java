...
public class Test1 extends Page {
  ...
  public void test(String id, String pwd) throws Exception {
	...
	//  test.log(LogStatus.PASS, "OR reposotry loaded");
	  ...
	  driver.findElement(By.xpath(uidxpath)).sendKeys(id); // driver is global in Page which is inherited , id is getting data from array 
		...
		if(actmsg != null)
		{
			Connection con=PoiConfig.makeConnection("e:\\corejava\\Book3.xls"); // have to make connection as before data is added to array from getData() yaha connection open nahi hai
  ...
  public Object[][] getData() throws Exception {
    return  Utility.PoiConfig.getData("e:\\corejava\\Book3.xls","Sheet1");
